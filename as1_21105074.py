...
a = int(input("enter three numbers whose avg is to be calculated: "))
b = int(input())
c = int(input())
...
student1 = [21105243, "Babandeepsingh", "M", "ECE", 9.0]
student2 = [21105235, "Ansh", "M", "ECE", 8.5]
student3 = [21105453, "jatin", "F", "ECE", 8.5]
